                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...reservations.map((reservation) {
                      ...
                      final bookingTimeRaw = reservation['startingSlot'];
                      final amount =
                          reservation['customer']['amount']?.toString() ?? '-';
                      final holes = reservation['holes']?.toString() ?? '-';
                      final players = reservation['persons']?.toString() ?? '-';
                      final carts = reservation['carts']?.toString() ?? '-';
                      final status =
                      ...
                      if (bookingDateRaw != null) {
                        try {
                          ...
                          bookingDate = DateFormat('EEE, MMM d').format(date);
                        } catch (_) {
                      ...
                      if (bookingTimeRaw != null) {
                        try {
                          final time =
                              DateFormat('HH:mm:ss').parse(bookingTimeRaw);
                          bookingTime = DateFormat('h:mma').format(time);
                        } catch (_) {
                      ...
                      final iconImage = (courseLogo != null &&
                              courseLogo.toString().startsWith('http'))
