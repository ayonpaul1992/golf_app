...
class DashboardPageState extends State<DashboardPage> {
  ...
  void _handleDeepLink() {
    ...
    print("✅ DashboardPage detected pending deep link on init.");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: DashboardAppBar(
        ...
        dshbId: '', // Pass the dshbId if needed
          ...
          onRefresh: () async {
            ...
            fetchUpcomingTeeTime().then((teeTime) {
              if (teeTime != null) {
                ...
                upcomingTeeTime = null; // Reset if no tee time found
              }
              setState(() {
                isLoading =
                    false; // Set loading state to false after refreshing
              });
            });
          },
